...
import DetailProductsModal from './pos/DetailProductsModal'
...
export default function CashierPOS() {
  ...
  useEffect(() => {
    const fetchCatalog = async () => {
      try {
        const catRes = await posApi.getCategories().catch(() => adminApi.getCategories())
      ...
      try {
        const prodRes = await posApi.getProducts().catch(() => adminApi.getProducts())
          ...
          <div className="flex-1 flex flex-col min-w-0 min-h-0 h-full overflow-hidden">
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="search-box flex-grow-1 max-w-xs">
                  <div
                    className="flex items-center gap-2 px-3.5 py-2 rounded-[5px] border text-sm shadow-xs transition-colors"
                    style={{
